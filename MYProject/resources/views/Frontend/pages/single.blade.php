                ...
                @foreach($data as $a)
                    <li class="product-item">
                        <div class="contain-product layout-default">
                            ...
                            <div class="info">
                                <b class="categories">Fruit</b>
                                <h4 class="product-title"><a href="#" class="pr-name">{{$a->name}}</a></h4>
                                <div class="price">
                                    <ins><span class="price-amount"><span class="currencySymbol">£</span>{{$a->price}}</span></ins>
